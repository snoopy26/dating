...
function get_dom($contents, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT)
{
...
//    $contents = retrieve_url_contents($url);
	...
	curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.152 Safari/535.19');
	...
	*/
	...
	//curl_setopt($ch, CURLOPT_REFERER, 'http://www.21cineplex.com/theater/bioskop-anggrek-xxi,15,JKTANGG.htm');
